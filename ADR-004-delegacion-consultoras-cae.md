...
2. **Quién puede crear/desactivar una `DelegacionTenant`**: § 11.1 ya cierra que nunca es Hydra por sí sola — queda abierto si el flujo de autoservicio recae en el administrador del Cliente Directo, en la Consultora, o en ambos con distinto alcance. Tiene implicaciones comerciales (¿es un flujo de venta autoservicio o gestionado por Hydra?) — coordinar con `docs/business/BUSINESS_ARCHITECTURE.md` cuando se desarrolle.
