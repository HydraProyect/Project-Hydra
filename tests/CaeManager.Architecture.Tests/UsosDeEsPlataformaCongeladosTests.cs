...
public class UsosDeEsPlataformaCongeladosTests
{
    ...
    /// Actualizado 2026-09-26 (ADR-011 § 8.7, punto 3: restablecimiento de 2FA por Soporte
    /// TALVEG). Nuevo fichero, <c>20260925203337_RestablecimientoSegundoFactorPorSoporte.cs</c>
    /// (+1 fichero, +2 apariciones, <see cref="CategoriaUso.MigracionManual"/>): la función
