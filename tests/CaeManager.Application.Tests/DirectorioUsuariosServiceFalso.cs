...
/// </summary>
public class DirectorioUsuariosServiceFalso(
    bool esVisible = true, Guid? tenantDelUsuario = null, bool cuentaActivaConRol = true)
    : IDirectorioUsuariosService
{
    ...
    /// <summary>Mismo criterio: acepta por defecto; los tests del tercero que dejó de serlo pasan <c>cuentaActivaConRol: false</c>.</summary>
