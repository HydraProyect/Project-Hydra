...
public class ClosedXmlPlantillaCombinadaService(ICentrosQueryContext centrosContext, IEmpresasQueryContext empresasContext, ITrabajadoresQueryContext trabajadoresContext) : IPlantillaCombinadaService
{
    ...
    public async Task<PlanImportacionCombinadaDto> AnalizarAsync(Stream archivo, CancellationToken cancellationToken = default)
    {
        ...
        // escritura resuelve ese nombre contra Clientes empresariales reales
        // (EjecutarImportacionCombinadaCommand siembra clientesIdPorRazonSocial
        // con este mismo discriminador, EsCritico != null, más los que la hoja
        // "Clientes" cree en esa misma ejecución). Si este conjunto incluyera
        // cualquier Empresa por nombre, una fila de Centros que referencia una
