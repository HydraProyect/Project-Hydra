...
public class MistralOcrOptions
{
    ...
    /// confianza por palabra/página — ver Project-Hydra-Negocio/tecnico/docs/ARQUITECTURA-IA-DOCUMENTAL.md
    ...
    /// el coste estimado de auditoría (Project-Hydra-Negocio/tecnico/docs/ARQUITECTURA-IA-DOCUMENTAL.md
