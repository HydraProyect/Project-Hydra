...
/// Project-Hydra-Negocio/seguridad/INFORME-AUDITORIA-2.md). Es la misma lista que <c>RolesConMenuCompleto</c>
/// de <c>CatalogoMenuLateral</c>: todos los roles de gestión CAE, incluido Consulta en
