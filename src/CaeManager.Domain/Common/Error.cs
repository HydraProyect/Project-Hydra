...
/// <see cref="Result{T}"/> — nunca una excepción (ver Project-Hydra-Negocio/tecnico/CODING_STANDARDS.md).
///
/// <b>Convención de <see cref="Codigo"/></b> (P2 #27 de
/// Project-Hydra-Negocio/MATURITY_REVIEW.md, "catálogo central de códigos de
