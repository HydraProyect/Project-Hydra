...
/// <summary>
/// Entidad perteneciente a un Tenant (ver Project-Hydra-Negocio/tecnico/docs/MULTITENANCY.md). Separada de
...
/// desde la Etapa 3 de <c>Project-Hydra-Negocio/tecnico/PLAN-MIGRACION-MULTITENANT.md</c> (cierre); antes
