...
/// multi-hoja del Cuadro de Control CAE de KHS). Pensada para dar de alta
/// rápidamente el resto de clientes de la cartera sin tener que rellenar un
/// libro con la estructura completa. Reutiliza EjecutarImportacionCommand
/// para escribir el plan resultante — el comando ya trata ClientesCentros
/// de forma genérica.
/// </summary>
