...
/// <summary>
/// Resuelve el Tenant de la sesión/ámbito actual (ver Project-Hydra-Negocio/tecnico/docs/MULTITENANCY.md).
...
/// Project-Hydra-Negocio/tecnico/docs/MULTITENANCY.md § 8 (Tenant Resolution Strategy).
///
