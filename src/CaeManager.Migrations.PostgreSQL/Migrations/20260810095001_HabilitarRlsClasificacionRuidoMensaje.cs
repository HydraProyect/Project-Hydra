...
namespace CaeManager.Migrations.PostgreSQL.Migrations
{
    /// <inheritdoc />
    /// <summary>
    /// RLS para ClasificacionesRuidoMensaje, en la misma tanda que la crea
    /// (AgregarClasificacionRuidoMensaje) — mismo criterio que
    ...
    /// </summary>
    public partial class HabilitarRlsClasificacionRuidoMensaje : Migration
    {
        private const string Tabla = "ClasificacionesRuidoMensaje";
