...
namespace CaeManager.Migrations.PostgreSQL.Migrations
{
    /// <inheritdoc />
    /// <summary>
    /// RLS para ClasificacionesRuidoDetalleGestion, en la misma tanda que la crea
    /// (AgregarClasificacionRuidoDetalleGestion) — mismo criterio que
    ...
    /// </summary>
    public partial class HabilitarRlsClasificacionRuidoDetalleGestion : Migration
    {
        private const string Tabla = "ClasificacionesRuidoDetalleGestion";
