...
namespace CaeManager.Migrations.PostgreSQL.Migrations
{
    ...
    [Migration("20260926133410_CorregirBackfillReclamacionBuzonIntegracionBajoRls")]
    partial class CorregirBackfillReclamacionBuzonIntegracionBajoRls
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CaeManager.Domain.Asignaciones.Asignacion", b =>
                {
                    ...
                    b.HasIndex("TenantId", "TrabajadorId", "CentroId")
            ...
            modelBuilder.Entity("CaeManager.Domain.AsistenteIa.PasoTareaAsistente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("AsistidoPorIa")
                        .HasColumnType("boolean");

                    b.Property<string>("AvisosJson")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("CamposPendientesJson")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<DateTime?>("ConfirmadoEnUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("EjecutadoEnUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("EntidadResultadoId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("OrdenAsistenteId")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.Property<Guid>("TareaAsistenteId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TareaAsistenteId", "Posicion")
                        .IsUnique();

                    b.ToTable("PasosTareaAsistente", null, t =>
                        {
                            t.HasCheckConstraint("CK_PasosTareaAsistente_EjecucionTrasConfirmacion", "\"Estado\" NOT IN ('Confirmado', 'Ejecutado', 'Fallido') OR \"ConfirmadoEnUtc\" IS NOT NULL");

                            t.HasCheckConstraint("CK_PasosTareaAsistente_EjecutadoConFecha", "\"Estado\" <> 'Ejecutado' OR \"EjecutadoEnUtc\" IS NOT NULL");
                        });
                });

            modelBuilder.Entity("CaeManager.Domain.AsistenteIa.TareaAsistente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("DescartadaEnUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<Guid?>("PlanConfirmadoComoUsuarioSimuladoId")
                        .HasColumnType("uuid");

                    b.Property<DateTime?>("PlanConfirmadoEnUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("PlanConfirmadoPorActorRealUsuarioId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("TenantId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("TenantOrigenId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("UsuarioSimuladoId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "ActorRealUsuarioId", "ActualizadaEnUtc");

                    b.ToTable("TareasAsistente", null, t =>
                        {
                            t.HasCheckConstraint("CK_TareasAsistente_ConfirmadaConConfirmacion", "\"Estado\" NOT IN ('Confirmada', 'Terminada') OR (\"PlanConfirmadoEnUtc\" IS NOT NULL AND \"PlanConfirmadoPorActorRealUsuarioId\" IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("CaeManager.Domain.AsistenteIa.TurnoTareaAsistente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("TextoEnmascarado")
                        .HasMaxLength(8000)
                    ...
                    b.HasIndex("TareaAsistenteId", "Numero")
                        .IsUnique();

                    b.ToTable("TurnosTareaAsistente", (string)null);
                });
            ...
            modelBuilder.Entity("CaeManager.Domain.BusquedaGlobal.EventoRecienteUsuario", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "UsuarioId", "OcurridoEnUtc")
                        .IsDescending(false, false, true);

                    b.ToTable("EventosRecientesUsuario", (string)null);
                });
            ...
            modelBuilder.Entity("CaeManager.Domain.Configuracion.EstadoAutomatizacion", b =>
                {
                    ...
                    b.Property<string>("UltimoMensajeError")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
                    ...
                    b.Property<int?>("UltimosElementosAfectados")
                        .HasColumnType("integer");

                    b.Property<int?>("UltimosElementosEvaluados")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CaeManager.Domain.Documentos.AcreditacionDocumentoPlataforma", b =>
                {
                    ...
                    b.Property<DateOnly?>("FechaVencimientoEnPlataforma")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("CaeManager.Domain.Documentos.RevisionIaDocumento", b =>
                {
                    ...
                    b.Property<Guid?>("AuditoriaExtraccionIaId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AuditoriaExtraccionIaId")
                        .IsUnique();
            ...
            modelBuilder.Entity("CaeManager.Domain.Documentos.TipoDocumento", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Notas = "Recordatorio cada 3 años. Obligatorio por defecto (2026-08-09): formación PRL Art. 19.",
                            Orden = 4,
                            PerfilDocumentoOficial = "Ninguno",
                            Requerido = "Si",
                            Sensibilidad = "DatosPersonales",
                        ...
                        new
                        {
                            ...
                            Notas = "No consta periodicidad de renovación. Obligatorio por defecto (2026-08-09): registro de entrega de información de riesgos del puesto.",
                            Orden = 8,
                            PerfilDocumentoOficial = "Ninguno",
                            Requerido = "Si",
                            Sensibilidad = "DatosPersonales",
                        ...
                        new
                        {
                            ...
                            Notas = "Vigente hasta cambios — vencimiento manual. Obligatorio por defecto (2026-08-09): un único tipo cubre la modalidad preventiva de la empresa, sea SPA, Propia o Mancomunada — no se modela como alternativas separadas (ver ROADMAP.md).",
                            Orden = 34,
                            PerfilDocumentoOficial = "Ninguno",
                            Requerido = "Si",
                            Sensibilidad = "SinDatosPersonales",
            ...
            modelBuilder.Entity("CaeManager.Domain.DocumentosIa.AuditoriaExtraccionIa", b =>
                {
                    ...
                    b.Property<string>("ModeloExacto")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");
                    ...
                    b.Property<string>("ProveedoresInvocados")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)");
                    ...
                    b.Property<string>("VersionPipeline")
                        .IsRequired()
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("CaeManager.Domain.Integraciones.EventoWebhook", b =>
                {
                    ...
                    b.Property<bool>("PayloadRedactado")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
            ...
            modelBuilder.Entity("CaeManager.Domain.Plataforma.ConcesionPrivilegio", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ConcedidaPorUsuarioId")
                        .HasColumnType("uuid");

                    b.Property<DateTime>("CreadoEnUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<bool>("EsAlcanceGlobal")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("MotivoConcesion")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<Guid>("UsuarioPlataformaId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UsuarioPlataformaId", "Estado");

                    b.ToTable("ConcesionesPrivilegio", null, t =>
                        {
                            t.HasCheckConstraint("CK_ConcesionesPrivilegio_AlcanceGlobalSoloCapacidadesAdmitidas", "NOT \"EsAlcanceGlobal\" OR \"Capacidad\" IN ('AdminPlataforma', 'SoporteLectura')");

                            t.HasCheckConstraint("CK_ConcesionesPrivilegio_SoporteGlobalConVigenciaFinita", "NOT (\"EsAlcanceGlobal\" AND \"Capacidad\" = 'SoporteLectura') OR \"VigenciaHasta\" IS NOT NULL");
                        });
                });

            modelBuilder.Entity("CaeManager.Domain.Plataforma.EstadoBootstrapPlataforma", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime>("DesignadaEnUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid>("UsuarioRaizId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CaeManager.Domain.Plataforma.SesionPrivilegiada", b =>
                {
                    ...
                    b.Property<Guid>("ConcesionPrivilegioId")
                        .HasColumnType("uuid");

                    b.Property<DateTime>("ExpiraEnUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime>("InicioEnUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<Guid>("TenantObjetivoId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ConcesionPrivilegioId");

                    b.HasIndex("ExpiraEnUtc")
                        .HasDatabaseName("IX_SesionesPrivilegiadas_Abiertas")
                        .HasFilter("\"CerradaEnUtc\" IS NULL");

                    b.HasIndex("TenantObjetivoId", "InicioEnUtc");

                    b.ToTable("SesionesPrivilegiadas", (string)null);
                });

            modelBuilder.Entity("CaeManager.Domain.Plataforma.TenantAlcanzadoPorConcesion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ConcesionPrivilegioId", "TenantId")
                        .IsUnique();

                    b.ToTable("TenantsAlcanzadosPorConcesion", (string)null);
                });
            ...
            modelBuilder.Entity("CaeManager.Domain.RelacionesEmpresariales.RelacionEmpresarial", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("EnmarcadaEnId")
                        .HasColumnType("uuid");

                    b.Property<string>("OrigenVigencia")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)");

                    b.Property<Guid>("ProveedoraId")
                        .HasColumnType("uuid");
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("TenantId", "ClienteId"), new[] { "ProveedoraId" });

                    b.HasIndex("TenantId", "EnmarcadaEnId");

                    b.HasIndex("TenantId", "Id")
                        .IsUnique();

                    b.HasIndex("TenantId", "ProveedoraId");

                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("TenantId", "ProveedoraId"), new[] { "ClienteId" });

                    b.HasIndex("TenantId", "ProveedoraId", "ClienteId")
                        .IsUnique()
                        .HasDatabaseName("IX_RelacionesEmpresariales_ParActivo")
                        .HasFilter("\"VigenciaHasta\" IS NULL");

                    b.ToTable("RelacionesEmpresariales", null, t =>
                        {
            ...
            modelBuilder.Entity("CaeManager.Domain.Soporte.RegistroActividadSoporte", b =>
                {
                    ...
                    b.Property<Guid?>("SesionPrivilegiadaId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RegistrosActividadSoporte", null, t =>
                        {
                            t.HasCheckConstraint("CK_RegistrosActividadSoporte_UnSoloAgrupador", "(\"DelegacionTenantId\" IS NULL) <> (\"SesionPrivilegiadaId\" IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("CaeManager.Domain.AsistenteIa.PasoTareaAsistente", b =>
                {
                    b.HasOne("CaeManager.Domain.AsistenteIa.TareaAsistente", null)
                        .WithMany("Pasos")
                        .HasForeignKey("TareaAsistenteId")
            ...
            modelBuilder.Entity("CaeManager.Domain.Plataforma.SesionPrivilegiada", b =>
                {
                    b.HasOne("CaeManager.Domain.Plataforma.ConcesionPrivilegio", null)
                        .WithMany()
                        .HasForeignKey("ConcesionPrivilegioId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CaeManager.Domain.RelacionesEmpresariales.RelacionEmpresarial", b =>
                {
                    ...
                    b.HasOne("CaeManager.Domain.RelacionesEmpresariales.RelacionEmpresarial", null)
                        .WithMany()
                        .HasForeignKey("TenantId", "EnmarcadaEnId")
                        .HasPrincipalKey("TenantId", "Id")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("CaeManager.Domain.Plataforma.ConcesionPrivilegio", b =>
                {
                    b.Navigation("TenantsAlcanzados");
                });
