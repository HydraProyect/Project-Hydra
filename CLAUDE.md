...
- `ADR-001` (guía técnica multi-tenant, reactivada) · `ADR-002` (superseded, histórico) · `ADR-003` (decisión vigente) · `ADR-004` (delegación de gestión CAE a consultoras externas, diseño pendiente de implementar).
