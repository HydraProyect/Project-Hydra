...
> (✅ hecho, N accesos de plataforma + copy de criterios de validación) · **Lote 0-G** = 0.9 (selección múltiple oculta tras toggle + densidad de fila,
...
### (0.9) Selección múltiple oculta tras toggle + densidad de fila — transversal — Lote 0-G (pendiente, siguiente)
