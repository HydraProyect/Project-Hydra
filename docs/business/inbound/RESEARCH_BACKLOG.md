...
1. ~~**¿Qué es "Outbound" en Hydra?**~~ **Respondida (2026-08-07)**: el propietario del producto confirmó la definición formal en `docs/business/OUTBOUND_CAE.md` (término `Approved` en `docs/business/UBIQUITOUS_LANGUAGE.md`, ver `DECISION_LOG.md` entrada 2026-08-07). CAE Outbound = delegación integral de la gestión/carga/actualización/seguimiento de la documentación preventiva de una empresa hacia las plataformas de sus clientes (rol Contratista/Subcontrata) — opuesto a CAE Inbound (rol Titular/Principal). Sigue existiendo la nota de desambiguación con el uso de "Inbound" de esta carpeta (plataformas externas a consumir/sincronizar) — ver `docs/business/OUTBOUND_CAE.md` § "Nota de desambiguación" y `README.md` de esta carpeta.
