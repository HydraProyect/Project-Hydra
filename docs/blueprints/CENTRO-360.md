...
| 8 | El texto secundario usa el valor que **incumple contraste** | `06` § 2.5 (DDL-029) | Alto: es un incumplimiento objetivo | **Cerrada** (verificado en navegador, 2026-08-09): `--color-text-muted` computado en `/centros` es `#5f6e84` (5.18:1), no el `#738196` (3.96:1) que incumplía. Mismo fix global, nunca reauditado aquí. |
